...
namespace AdventOfCode2020.Tests.Solutions.Day06
{
    public class Day6Tests
    {
        ...
        {
            // Arrange
            var daySolution = new AdventOfCode2020.Solutions.Day06.Day6();

            // Act
            var result = daySolution.GetResult(Part.One);

            // Assert
            Assert.Equal("6590", result);
        }
